...
fn test_brace() {
    ...
    show_positional(template, &arguments, "$$ :: NULL is a friend of Lennon, but not a friend of Clapton! ::$$");

    let arguments = vec!["A".to_string(), "B".to_string(), "C".to_string(), "D".to_string()];
...
fn test_brace_named() {
    ...
    show_named(template, &context, " NULL val NULL {NULL} NULL } } NULL NULL NULL");
    ...
    show_named(template, &context, " a_val a_Y_0_val _b_Z_val {NULL} NULL } } NULL NULL NULL");
}
